<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") { # If the recieved request was a POST request
        ...
        $sql = "SELECT `userID`, `pubKey` FROM `users` WHERE username='$contactName';"; # SQL statement to fetch the userID, and public Key of the user with the associated username
