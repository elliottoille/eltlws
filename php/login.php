<?php
    if($_SERVER["REQUEST_METHOD"] == "POST") { # If the server recieves a POST request then
        ...
        $username = $_POST["username"]; # Set the username equal to the username passed by the POST method
        $password = $_POST["password"]; # Set the password equal to the password passed by the POST method
